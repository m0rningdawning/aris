...
def draw_next_section(screen, tetromino, board_width, score, lines, level, time):
    ...
    screen.print_at(f"Lv:{level}", board_width * 3, 8)
    screen.print_at(f"L:{lines}", board_width * 3, 9)
    screen.print_at(f"T:{time}", board_width * 3 + 7, 8)
    screen.print_at(f"S:{score}", board_width * 3 + 7, 9)
...
def draw_end_screen(screen, board_width, score, lines, level, time):
    screen.print_at('========================== ', board_width + 1, 7)
    screen.print_at('!       GAME OVER        ! ', board_width + 1, 8)
    screen.print_at('!------------------------! ', board_width + 1, 9)
    screen.print_at('! Lv:      | T:          ! ', board_width + 1, 10)
    screen.print_at('!------------------------! ', board_width + 1, 11)
    screen.print_at('! Ln:      | S:          ! ', board_width + 1, 12)
    ...
    screen.print_at(f"{level}", board_width * 2 - 3, 10)
    screen.print_at(f"{lines}", board_width * 2 - 3, 12)
    screen.print_at(f"{time}", board_width * 3 - 3, 10)
    screen.print_at(f"{score}", board_width * 3 - 3, 12)
